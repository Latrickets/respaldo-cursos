<?php
    ...
    if(isset($_GET["enviar-hdn"])){
        if ($nombre == $_GET["nombre_txt"] && $password == $_GET["password_txt"]) {
            ...
            ".<br>El sexo que seleccionaste por GET es ".$_GET["sexo_rdo"];
        }else{
            header("Location: formulario.php?error=si");
        }
    }else if(isset($_POST["enviar-hdn"])){
        if ($nombre == $_POST["nombre_txt"] && $password == $_POST["password_txt"]) {
            ...
            ".<br>El sexo que seleccionaste por POST es ". $_POST["sexo_rdo"];
        }else{
            header("Location: formulario.php?error=si");
        }
    }
