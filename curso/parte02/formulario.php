...
<head>
    ...
    <script>
        ...
        window.onload = function() {
            document.getElementById("enviar-get").onclick = function(){validarDatosGET()};
            document.getElementById("enviar-post").onclick = function(){validarDatosPOST()};
        }
    </script>
</head>
<body>
    ...
    <form action="validar-datos.php" name="valida_datos_get_frm" method="GET"
    enctype="application/x-www-form-urlencoded">
        ...
        Femenino
        <br><br>
        <input type="hidden" name="enviar-hdn" value="get">
        <input type="button" id="enviar-get" name="enviar_btn" value="Enviar x GET">

    </form>
    <hgroup><h1>Formulario de datos POST</h1></hgroup>
    <form action="validar-datos.php" name="valida_datos_post_frm" method="POST"
    enctype="application/x-www-form-urlencoded">
        <label for="">Ingresa tu nombre</label>
        <input type="text" name="nombre_txt">
        <br><br>
        ...
        Femenino
        <br><br>
        <input type="hidden" name="enviar-hdn" value="post">
